...
module.exports = angular.module('spinnaker.bmc.pipeline.stage.createLoadBalancerStage', [
  ...
  .config(function(pipelineConfigProvider, settings) {
    ...
    if (settings.feature && settings.feature.infrastructureStages) {
      pipelineConfigProvider.registerStage({
        key: 'upsertBmcLoadBalancers',
        label: 'Create BMC Load Balancers',
        description: 'Creates one or more BMC load balancers.' +
